...
function Sidebar() {
  return (
    <aside className="w-70 border border-stone-200 bg-white pt-2 space-y-15 h-screen relative ">
      <div className="fixed w-66">
        <div>
          <Link
            to="/"
        ...
        <div className="pt-5 ">
          ...
          <div className="space-y-2">
            ...
            <SidebarItem to="maintenance">
              <span>
                <HiOutlineWrenchScrewdriver className="h-5 w-5" />
              </span>
              Maintenance
            </SidebarItem>
            <SidebarItem to="finance">
              <span>
